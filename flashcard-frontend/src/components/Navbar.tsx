...
const Navbar: React.FC= () => {
  ...
  return (
    <nav className="w-full bg-[#0F0F0F] text-white flex items-center justify-between p-4 shadow-md">
      ...
      <button
        ...
        className="bg-[#191919] text-zinc-200 border-zinc-800 py-2 px-4 rounded-xl border-2 font-medium shadow-sm whitespace-nowrap"
      >
